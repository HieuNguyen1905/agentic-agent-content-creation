...
[![OpenAI](https://img.shields.io/badge/OpenAI-ChatGPT-412991?style=for-the-badge)](https://platform.openai.com/)
...
│   ├── llm_client.py           # OpenAI ChatGPT integration
...
Create a `.env` file in the project root (used by the Python agents):
