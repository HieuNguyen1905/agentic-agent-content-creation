...
1. Tóm tắt các chủ đề và chủ đề chính được đề cập
...
4. Tạo một lời nhắc viết chi tiết cho trình tảo blog AI
...
"""
        ...
        self.logger.info("Generating initial blog topic from RSS content with OpenAI...")

        try:
            result = await self.llm_client.generate(
                prompt,
                system_prompt="Bạn là một chiến lược gia chủ đề blog sáng tạo, người tìm kết nối trong tin tức và tạo các lời nhắc viết hấp dẫn.",
                temperature=0.7
            )
