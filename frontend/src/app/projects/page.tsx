...
const featuredProjects = [
  ...
  },
  {
    ...
    description:
      "An integration framework that showcases advanced OpenAI ChatGPT agent capabilities for building sophisticated AI-driven applications on modern infrastructure.",
    features: [
      'Seamless integration with OpenAI ChatGPT models',
      'Support for complex multi-agent conversations',
      'Production-ready patterns for AI orchestration',
      'Extensible SDK for custom agent development'
    ],
    technologies: ['Python', 'OpenAI API', 'AI/ML'],
    stars: 10,
    githubUrl: 'https://github.com/example-user/openai-agents-sdk',
    projectType: 'AI/ML'
  },
  {
